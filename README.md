...
-  Esta ruta debe obtener los primeros 15 videojuegos que se encuentren con la palabra recibida por query./list
-  Debe poder buscarlo independientemente de mayúsculas o minúsculas. /listo
-  Si no existe el videojuego, debe mostrar un mensaje adecuado. /listo
-  Debe buscar tanto los de la API como los de la base de datos.// listo

#### **📍 POST | /videogames** // LISTO
